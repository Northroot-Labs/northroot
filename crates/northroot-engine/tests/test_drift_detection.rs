...
use northroot_engine::{commit_set_root, commit_seq_root, compute_tensor_root, MerkleRowMap, compute_execution_roots};
use serde_json::json;
...
const BASELINE_ROOTS: &[(&str, &str)] = &[
    ...
    ("commit_set_root_empty", "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"),
    ("commit_set_root_single", "sha256:5d4cc820b37f3d1fd0c6e04ed50a56ead8d497ecfd3c25c749855ed9d852837d"),
    ("commit_set_root_three_items", "sha256:b294e910ea566785d193092a0f165f09d7aa909a44d6e41c1ab19846a9092bdb"),
    // commit_seq_root baselines
    ("commit_seq_root_empty", "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"),
    ("commit_seq_root_single", "sha256:5d4cc820b37f3d1fd0c6e04ed50a56ead8d497ecfd3c25c749855ed9d852837d"),
    ("commit_seq_root_three_items", "sha256:b294e910ea566785d193092a0f165f09d7aa909a44d6e41c1ab19846a9092bdb"),
    // compute_tensor_root baselines
    ("compute_tensor_root_empty", "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"),
    ("compute_tensor_root_single", "sha256:5d4cc820b37f3d1fd0c6e04ed50a56ead8d497ecfd3c25c749855ed9d852837d"),
    ("compute_tensor_root_three_items", "sha256:b294e910ea566785d193092a0f165f09d7aa909a44d6e41c1ab19846a9092bdb"),
    // MerkleRowMap baselines
    ("merkle_row_map_empty", "sha256:6e340b9cffb37a989ca544e6bb780a2c78901d3fb33738768511a30617afa01d"),
    ("merkle_row_map_single", "sha256:86485aab8bba735c846f58e5b6c768f8cb4a44bf526e90da31140f16d59816b4"),
    ("merkle_row_map_multiple", "sha256:9394ea056c013c4d185d56bae350d6874c1653fee1ddaf7aba6a6afb58c82de4"),
    // compute_execution_roots baselines (trace_set_root values)
    ("compute_execution_roots_empty_trace_set", "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"),
    ("compute_execution_roots_single_trace_set", "sha256:5d4cc820b37f3d1fd0c6e04ed50a56ead8d497ecfd3c25c749855ed9d852837d"),
    ("compute_execution_roots_multiple_trace_set", "sha256:1a478d6e1f4552286397eb9f2a86cb56e3f33f082a4613ea55537c819369f2ec"),
    // compute_execution_roots baselines (trace_seq_root values)
    ("compute_execution_roots_empty_trace_seq", "sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"),
    ("compute_execution_roots_single_trace_seq", "sha256:5d4cc820b37f3d1fd0c6e04ed50a56ead8d497ecfd3c25c749855ed9d852837d"),
...
fn test_commit_set_root_baselines() {
    ...
    // Single item
    let single = commit_set_root(&["sha256:1111111111111111111111111111111111111111111111111111111111111111".to_string()]);
    ...
    assert_ne!(root1, root3, "Different hashes should produce different root");
...
fn test_commit_seq_root_baselines() {
    ...
    // Single item
    let single = commit_seq_root(&["sha256:1111111111111111111111111111111111111111111111111111111111111111".to_string()]);
...
fn test_compute_tensor_root_baselines() {
    ...
    // Single hash
    let single = compute_tensor_root(&["sha256:1111111111111111111111111111111111111111111111111111111111111111".to_string()]);
    ...
    // Should be order-independent
    assert_eq!(root1, root2, "compute_tensor_root should be order-independent");
...
fn test_merkle_row_map_baselines() {
    ...
    assert_eq!(map1.compute_root(), map2.compute_root(), "MerkleRowMap should be order-independent");
...
fn test_compute_execution_roots_baselines() {
    ...
    let empty_roots = compute_execution_roots(&[], "sha256:3333333333333333333333333333333333333333333333333333333333333333".to_string());
    ...
    // Print for baseline population
    println!("compute_execution_roots empty: trace_set_root={}, trace_seq_root={:?}", 
             empty_roots.trace_set_root, empty_roots.trace_seq_root);
    println!("compute_execution_roots single: trace_set_root={}, trace_seq_root={:?}", 
             single_roots.trace_set_root, single_roots.trace_seq_root);
    println!("compute_execution_roots multiple: trace_set_root={}, trace_seq_root={:?}", 
...
fn test_root_computation_baselines() {
    ...
    let single_set = commit_set_root(&["sha256:1111111111111111111111111111111111111111111111111111111111111111".to_string()]);
    ...
    let single_seq = commit_seq_root(&["sha256:1111111111111111111111111111111111111111111111111111111111111111".to_string()]);
    ...
    let single_tensor = compute_tensor_root(&["sha256:1111111111111111111111111111111111111111111111111111111111111111".to_string()]);
    if let Some(expected) = baseline_map.get("compute_tensor_root_single") {
        if single_tensor != *expected {
            mismatches.push(("compute_tensor_root_single", expected, single_tensor.clone()));
        }
    }
    ...
    if let Some(expected) = baseline_map.get("compute_tensor_root_three_items") {
        if three_tensor != *expected {
            mismatches.push(("compute_tensor_root_three_items", expected, three_tensor.clone()));
        }
    }
    ...
    if let Some(expected) = baseline_map.get("compute_execution_roots_empty_trace_set") {
        if empty_exec.trace_set_root != *expected {
            mismatches.push(("compute_execution_roots_empty_trace_set", expected, empty_exec.trace_set_root.clone()));
        }
    }
    if let Some(expected) = baseline_map.get("compute_execution_roots_empty_trace_seq") {
        if let Some(ref seq_root) = empty_exec.trace_seq_root {
            if seq_root != *expected {
                mismatches.push(("compute_execution_roots_empty_trace_seq", expected, seq_root.clone()));
            }
        }
    }
    ...
    if let Some(expected) = baseline_map.get("compute_execution_roots_single_trace_set") {
        if single_exec.trace_set_root != *expected {
            mismatches.push(("compute_execution_roots_single_trace_set", expected, single_exec.trace_set_root.clone()));
        }
    }
    if let Some(expected) = baseline_map.get("compute_execution_roots_single_trace_seq") {
        if let Some(ref seq_root) = single_exec.trace_seq_root {
            if seq_root != *expected {
                mismatches.push(("compute_execution_roots_single_trace_seq", expected, seq_root.clone()));
            }
        }
    }
    ...
    if let Some(expected) = baseline_map.get("compute_execution_roots_multiple_trace_set") {
        if multi_exec.trace_set_root != *expected {
            mismatches.push(("compute_execution_roots_multiple_trace_set", expected, multi_exec.trace_set_root.clone()));
        }
    }
    if let Some(expected) = baseline_map.get("compute_execution_roots_multiple_trace_seq") {
        if let Some(ref seq_root) = multi_exec.trace_seq_root {
            if seq_root != *expected {
                mismatches.push(("compute_execution_roots_multiple_trace_seq", expected, seq_root.clone()));
            }
        }
    }
    ...
    if !mismatches.is_empty() {
        ...
        panic!("Root computation drift detected in {} test(s)", mismatches.len());
    }
}
...
fn test_root_computations_are_deterministic() {
    ...
    assert_eq!(root7, root8, "MerkleRowMap::compute_root should be deterministic");
    ...
    assert_eq!(roots1.trace_set_root, roots2.trace_set_root, "compute_execution_roots should be deterministic");
    assert_eq!(roots1.trace_seq_root, roots2.trace_seq_root, "compute_execution_roots should be deterministic");
}
