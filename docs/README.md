...
- [Extending Northroot](developer/extending.md) - Custom backends and filters

### For Operators
- [Deployment Guide](operator/deployment.md) - Production deployment
- [Kubernetes Security](operator/k8s-security.md) - K8s security practices
- [Secrets Management](operator/secrets.md) - Secret handling

### Security
- [Security Documentation](security/README.md) - Threat model and security analysis
- [Threat Model](security/threat-model.md) - Attack surface and hardening requirements
